...
class contribuyentes extends MY_Controller {
    ...
    public function registro() {
        ...
        $this->form_validation->set_rules('cirif', 'CI / RIF', 'trim|required|callback__es_cirif|');
        $this->form_validation->set_rules('nombre', 'Nombre / Razón Social', 'trim|required');
        $this->form_validation->set_rules('direccion', 'Dirección de Habitación / Domicilio Fiscal', 'trim|required');
        ...
        $this->form_validation->set_rules('telefono1', 'Teléfono de contacto', 'trim|required');
        $this->form_validation->set_rules('telefono2', 'Teléfono alternativo', 'trim|required');
        if ($this->form_validation->run() == TRUE) {
