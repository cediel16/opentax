...
<hr>
<div class="row-fluid">
    <div class="alert alert-block alert-warning span12">
        <h4 class="alert-heading">¿Estas seguro que deseas eliminar este contribuyente?</h4>
        ...
        <div class="span12 text-center">
            ...
            <?php echo form_submit('', 'Sí', 'class="btn btn-warning"') ?>
        </div>
        <?php echo form_close() ?>
    </div>
</div>